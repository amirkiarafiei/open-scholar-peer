...
# 1. Copy adapter to project (.agents/ for current discovery, .agent/ for forward compat)
...
echo -e "\n${GREEN}Done!${NC}\n"
echo "Notes:"
echo "  - Antigravity does NOT support subagents. The Q&A engine (/5-osp-qa) will"
echo "    fall back to self-reflection mode (documented in KNOWN_LIMITATIONS.md)."
echo "  - Type / in Antigravity Agent chat to see workflows."
