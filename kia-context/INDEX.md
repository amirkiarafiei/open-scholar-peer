...
| `BRAINSTORM.md` | Decisions D1–D48 and open questions O1–O26. D1–D11 reconstructed; D12 onward live. Closed so far: O12 (by M13), O1, O2 and O3 (by M15), O24 (D39) and O23 (D40, completed 2026-09-22 — the first closure missed a second spelling). |
...
| `D` | Decision | `BRAINSTORM.md` | D1–D48 |
