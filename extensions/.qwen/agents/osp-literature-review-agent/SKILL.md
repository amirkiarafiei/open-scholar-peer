...
Print the **opening block** defined in `.qwen/defaults/phase_block_template.md`, labelled
...
failed. The template at `.qwen/defaults/round_strategy_template.md` has a line for each.
...
Use `.qwen/defaults/round_strategy_template.md` as the skeleton for each round. Fill in:
