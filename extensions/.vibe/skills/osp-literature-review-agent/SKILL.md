...
Print the **opening block** defined in `.vibe/defaults/phase_block_template.md`, labelled
...
failed. The template at `.vibe/defaults/round_strategy_template.md` has a line for each.
...
Use `.vibe/defaults/round_strategy_template.md` as the skeleton for each round. Fill in:
