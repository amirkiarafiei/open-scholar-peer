...
ends. **`.kilo/defaults/phase_block_template.md` is the only definition of their format** — the rail, the
...
`.kilo/defaults/search_via_cli.md` holds the commands, the `batch` form to prefer, and
