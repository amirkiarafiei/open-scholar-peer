...
Print the **opening block** defined in `.cursor/defaults/phase_block_template.md`, labelled
...
failed. The template at `.cursor/defaults/round_strategy_template.md` has a line for each.
