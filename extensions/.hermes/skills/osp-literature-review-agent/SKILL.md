...
Print the **opening block** defined in `.hermes/defaults/phase_block_template.md`, labelled
...
failed. The template at `.hermes/defaults/round_strategy_template.md` has a line for each.
...
Use `.hermes/defaults/round_strategy_template.md` as the skeleton for each round. Fill in:
