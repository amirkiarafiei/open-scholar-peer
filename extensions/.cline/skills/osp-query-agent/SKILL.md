...
1. Open or initialize `.brain/raw/05_qa_<criterion_slug>.md` from the template at `.cline/defaults/qa_pair_template.md`.
...
`.brain/raw/05_qa_<slug>.md` follows `.cline/defaults/qa_pair_template.md` exactly:
- `# Q&A — <criterion label>`
