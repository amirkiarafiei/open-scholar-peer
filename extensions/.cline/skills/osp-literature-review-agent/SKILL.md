...
Print the **opening block** defined in `.cline/defaults/phase_block_template.md`, labelled
...
failed. The template at `.cline/defaults/round_strategy_template.md` has a line for each.
...
Use `.cline/defaults/round_strategy_template.md` as the skeleton for each round. Fill in:
