...
Print the **opening block** defined in `.opencode/defaults/phase_block_template.md`, labelled
...
failed. The template at `.opencode/defaults/round_strategy_template.md` has a line for each.
...
Use `.opencode/defaults/round_strategy_template.md` as the skeleton for each round. Fill in:
