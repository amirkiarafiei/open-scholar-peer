...
- **Prefer subagents** for the Q&A engine on tools that support them (Claude Code, Cursor, Gemini CLI, Copilot CLI, Codex CLI, Qwen Code, OpenCode, Junie, Kiro, Kimi Code, Antigravity).
