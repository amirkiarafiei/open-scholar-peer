...
Print the **opening block** defined in `.agent/defaults/phase_block_template.md`, labelled
...
failed. The template at `.agent/defaults/round_strategy_template.md` has a line for each.
...
Use `.agent/defaults/round_strategy_template.md` as the skeleton for each round. Fill in:
