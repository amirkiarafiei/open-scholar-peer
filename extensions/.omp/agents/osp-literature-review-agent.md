...
Print the **opening block** defined in `.omp/defaults/phase_block_template.md`, labelled
...
failed. The template at `.omp/defaults/round_strategy_template.md` has a line for each.
...
Use `.omp/defaults/round_strategy_template.md` as the skeleton for each round. Fill in:
