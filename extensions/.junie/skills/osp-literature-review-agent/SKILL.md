...
Print the **opening block** defined in `.junie/defaults/phase_block_template.md`, labelled
...
failed. The template at `.junie/defaults/round_strategy_template.md` has a line for each.
...
Use `.junie/defaults/round_strategy_template.md` as the skeleton for each round. Fill in:
