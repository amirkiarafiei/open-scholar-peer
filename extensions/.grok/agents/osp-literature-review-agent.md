...
Print the **opening block** defined in `.grok/defaults/phase_block_template.md`, labelled
...
failed. The template at `.grok/defaults/round_strategy_template.md` has a line for each.
...
Use `.grok/defaults/round_strategy_template.md` as the skeleton for each round. Fill in:
