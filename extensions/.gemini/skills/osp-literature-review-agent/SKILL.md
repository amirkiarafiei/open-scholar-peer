...
Print the **opening block** defined in `.gemini/defaults/phase_block_template.md`, labelled
...
failed. The template at `.gemini/defaults/round_strategy_template.md` has a line for each.
...
Use `.gemini/defaults/round_strategy_template.md` as the skeleton for each round. Fill in:
