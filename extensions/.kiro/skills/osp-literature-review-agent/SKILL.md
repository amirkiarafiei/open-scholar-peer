...
Print the **opening block** defined in `.kiro/defaults/phase_block_template.md`, labelled
...
failed. The template at `.kiro/defaults/round_strategy_template.md` has a line for each.
...
Use `.kiro/defaults/round_strategy_template.md` as the skeleton for each round. Fill in:
