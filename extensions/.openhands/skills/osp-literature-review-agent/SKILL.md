...
Print the **opening block** defined in `.openhands/defaults/phase_block_template.md`, labelled
...
failed. The template at `.openhands/defaults/round_strategy_template.md` has a line for each.
...
Use `.openhands/defaults/round_strategy_template.md` as the skeleton for each round. Fill in:
