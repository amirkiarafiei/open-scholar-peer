...
Print the **opening block** defined in `.claude/defaults/phase_block_template.md`, labelled
...
failed. The template at `.claude/defaults/round_strategy_template.md` has a line for each.
...
Use `.claude/defaults/round_strategy_template.md` as the skeleton for each round. Fill in:
