...
ends. **`.kimi/defaults/phase_block_template.md` is the only definition of their format** — the rail, the
...
`.kimi/defaults/search_via_cli.md` holds the commands, the `batch` form to prefer, and
