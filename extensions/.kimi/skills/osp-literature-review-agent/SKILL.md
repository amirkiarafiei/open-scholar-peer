...
Print the **opening block** defined in `.kimi/defaults/phase_block_template.md`, labelled
...
failed. The template at `.kimi/defaults/round_strategy_template.md` has a line for each.
...
Use `.kimi/defaults/round_strategy_template.md` as the skeleton for each round. Fill in:
