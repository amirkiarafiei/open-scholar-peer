...
- [x] **Timeout wrapper** — all provider calls wrapped with execution timeout to prevent hangs (Semantic Scholar, arXiv); default 180s, overridable via `.env` or env var
